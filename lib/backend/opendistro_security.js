...
export default class SecurityBackend {
    ...
    async authenticate(credentials) {
        ...
        this.server.log(['info', '***** opendistro-security'], "file:SecurityBackend func:authenticate obj:authHeader " + JSON.stringify(authHeader));
        try {
            ...
            this.server.log(['info', '***** opendistro-security'], "file:SecurityBackend func:authenticate obj:response " + JSON.stringify(response));
    ...
    async authenticateWithHeader(headerName, headerValue, whitelistedHeadersAndValues, additionalAuthHeaders = {}) {
        ...
        try {
            ...
            this.server.log(['info', '***** opendistro-security'], "file:SecurityBackend func:authenticateWithHeader obj:credentials " + JSON.stringify(credentials));
            this.server.log(['info', '***** opendistro-security'], "file:SecurityBackend func:authenticateWithHeader obj:whitelistedHeadersAndValues " + JSON.stringify(this._esconfig.requestHeadersWhitelist));
            this.server.log(['info', '***** opendistro-security'], "file:SecurityBackend func:authenticateWithHeader obj:whitelistedHeadersAndValues " + JSON.stringify(whitelistedHeadersAndValues));
            ...
            this.server.log(['info', '***** opendistro-security'], "file:SecurityBackend func:authenticateWithHeader obj:headers " + JSON.stringify({headers: headers}));
            const response = await this._client('opendistro_security.authinfo', {
                headers: headers
            });

            this.server.log(['info', '***** opendistro-security'], "file:SecurityBackend func:authenticateWithHeader obj:response " + JSON.stringify(response));
