...
module.exports = function (pluginRoot, server, kbnServer, APP_ROOT, API_ROOT) {
    ...
    server.route({
            ...
            async handler(request, h) {
                server.log(['info', 'OpenDistro Security Basic Auth Routes'], "Basic auth routes /login ");
                try {
    ...
    server.route({
            ...
            async handler (request, h) {
                server.log(['info', 'OpenDistro Security Basic Auth Routes'], "Basic auth routes auth/login ");
                try {
    ...
    server.route({
        ...
        handler: (request, h) => {
            server.log(['info', 'OpenDistro Security Basic Auth Routes'], "Basic auth routes /auth/logout ");
    ...
    server.route({
            ...
            async handler(request, h) {
                ...
                server.log(['info', 'OpenDistro Security Basic Auth Routes'], "Basic auth routes /auth/anonymous ");
        ...
        server.route({
            ...
            handler(request, h) {
                server.log(['info', 'OpenDistro Security Basic Auth Routes'], "Basic auth routes /customerror ");
