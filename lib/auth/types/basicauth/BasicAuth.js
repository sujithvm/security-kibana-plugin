...
export default class BasicAuth extends AuthType {
    ...
    detectAuthHeaderCredentials(request, sessionCredentials = null) {
        ...
        if (request.headers[this.authHeaderName]) {
            ...
            this.server.log(['info', 'OpenDistro Security BasicAuth'], "BasicAuth detectAuthHeaderCredentials headerTrumpsSession " + headerTrumpsSession);

            if (sessionCredentials != null) {
                this.server.log(['info', 'OpenDistro Security BasicAuth'], "BasicAuth detectAuthHeaderCredentials sessionCredentials " + JSON.stringify(sessionCredentials));
            }
