...
export default class BasicAuth extends AuthType {
    ...
    detectAuthHeaderCredentials(request, sessionCredentials = null) {
        ...
        this.server.log(['info', '***** opendistro-security'], "file:BasicAuth func:detectAuthHeaderCredentials ");
        ...
        if (request.headers[this.authHeaderName]) {
            ...
            if (sessionCredentials !== null && sessionCredentials.authHeaderValue === authHeaderValue) {
                ...
                this.server.log(['info', '***** opendistro-security'], "file:BasicAuth func:detectAuthHeaderCredentials msg: session null");
            ...
            if (sessionCredentials !== null && ! headerTrumpsSession) {
                ...
                this.server.log(['info', '***** opendistro-security'], "file:BasicAuth func:detectAuthHeaderCredentials msg: session not null but headerTrumpsSession");

                return null;
            }

            this.server.log(['info', '***** opendistro-security'], "file:BasicAuth func:detectAuthHeaderCredentials msg:authHeaderValue " + authHeaderValue);
    ...
    async authenticate(credentials, options = {}, whitelistedHeadersAndValues, additionalAuthHeaders = {}) {
        ...
        this.server.log(['info', '***** opendistro-security'], "file:BasicAuth func:authenticate obj:credentials " + JSON.stringify(credentials));
        ...
        try {
            let user = await this.server.plugins.opendistro_security.getSecurityBackend().authenticateWithHeader(this.authHeaderName, credentials.authHeaderValue, whitelistedHeadersAndValues, additionalAuthHeaders);
            this.server.log(['info', '***** opendistro-security'], "file:BasicAuth func:authenticate obj:user " + JSON.stringify(user));
            let session = {
            ...
            this.server.log(['info', '***** opendistro-security'], "file:BasicAuth func:authenticate obj:session " + JSON.stringify(session));
            ...
            this.server.log(['info', '***** opendistro-security'], "file:BasicAuth func:authenticate msg:error");
            throw error;
        }
    }
    ...
    onUnAuthenticated(request, h, error) {
        ...
        this.server.log(['info', '***** opendistro-security'], "file:BasicAuth func:onUnAuthenticated msg:error");

        if (error instanceof MissingRoleError) {
            this.server.log(['info', '***** opendistro-security'], "file:BasicAuth func:onUnAuthenticated msg:missing role");
        ...
        this.server.log(['info', '***** opendistro-security'], "file:BasicAuth func:onUnAuthenticated obj:nextUrl " + nextUrl);
